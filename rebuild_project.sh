...
echo "============================================"
echo "Project 22: Order Book with PCIe Output"
echo "============================================"
echo ""
...
echo "  vivado_project/22-order-book.runs/impl_1/order_book_top_timing_summary_routed.rpt"
echo ""
echo "Bitstream location:"
echo "  vivado_project/22-order-book.runs/impl_1/order_book_top.bit"
echo ""
